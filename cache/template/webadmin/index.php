...
<div class="right">
	<div class="index_center">
		<div class="dfk_main">
			...
			<div class="dfk_info">
				<a href="webadmin.php?mod=order&state=wpay" target="_blank"><p><?php echo $tongji['order_wpay'] ?></p>待付款订单</a>
			</div>
			<div class="clear"></div>
		</div>
		<div class="dfk_main">
			...
			<div class="dfk_info">
				<a href="webadmin.php?mod=order&state=wsend" target="_blank"><p><?php echo $tongji['order_wsend'] ?></p>待发货订单</a>
			</div>
		</div>
		<div class="dfk_main">
			<div class="dfk_img3"><i></i></div>
			<div class="dfk_info">
				<a href="webadmin.php?mod=refund&state=wcheck" target="_blank"><p><?php echo $tongji['refund_wcheck'] ?></p>待审退款/货</a>
			</div>
		</div>
		<div class="dfk_main">
			<div class="dfk_img4"><i></i></div>
			<div class="dfk_info">
				<a href="webadmin.php?mod=cashout" target="_blank"><p><?php echo $tongji['cashout_js'] ?></p>待结算提现</a>
			</div>
		</div>	
		<div class="clear"></div>
		<div class="xtxx_fl mat10">
			<div class="xtxx" style="height:auto; border-bottom:0">
				...
				<tr>
					...
					<td><a href="webadmin.php?mod=product" target="_blank"><?php echo $tongji['product_num'] ?> <span>个</span></a></td>
				</tr>
				<tr style="background:#f9fafc">
					<td class="aright"><span>商品分类：</span></td>
					<td><a href="webadmin.php?mod=category" target="_blank"><?php echo $tongji['category_num'] ?> <span>个</span></a></td>
				</tr>
				<tr>
					<td class="aright"><span>商品品牌：</span></td>
					<td><a href="webadmin.php?mod=brand" target="_blank"><?php echo $tongji['brand_num'] ?> <span>个</span></a></td>
				</tr>
				<tr style="background:#f9fafc">
					<td class="aright"><span>评价总数：</span></td>
					<td><a href="webadmin.php?mod=comment" target="_blank"><?php echo $tongji['comment_num'] ?> <span>个</span></a></td>
				</tr>
				<tr>
					<td class="aright"><span>订单总数：</span></td>
					<td><a href="webadmin.php?mod=order" target="_blank"><?php echo $tongji['order_num'] ?> <span>个</span></a></td>
				</tr>
				<tr style="background:#f9fafc">
					<td class="aright"><span>退款退货：</span></td>
					<td><a href="webadmin.php?mod=refund" target="_blank"><?php echo $tongji['refund_num'] ?> <span>个</span></a></td>
				</tr>
				<!--<tr>
				...
				<tr>
					...
					<td><a href="webadmin.php?mod=tongji" target="_blank"><?php echo $tongji['iplog_num'] ?> <span>人</span></a></td>
				</tr>
				<tr style="background:#f9fafc">
					<td class="aright" width="80"><span>会员总数：</span></td>
					<td><a href="webadmin.php?mod=user" target="_blank"><?php echo $tongji['user_num'] ?> <span>人</span></a></td>
				</tr>
				<tr>
					<td class="aright"><span>账户余额：</span></td>
					<td><a href="webadmin.php?mod=moneylog" target="_blank"><?php echo $tongji['user_money'] ?> <span>元</span></a></td>
				</tr>
				<tr style="background:#f9fafc">
					<td class="aright"><span>积分余额：</span></td>
					<td><a href="webadmin.php?mod=pointlog" target="_blank"><?php echo $tongji['user_point'] ?> <span>个</span></a></td>
				</tr>
				<tr>
					<td class="aright" width="80"><span>提现总数：</span></td>
					<td><a href="webadmin.php?mod=cashout" target="_blank"><?php echo $tongji['cashout_num'] ?> <span>笔</span></a></td>
				</tr>
				<tr style="background:#f9fafc">
					<td class="aright"><span>签到总数：</span></td>
					<td><a href="webadmin.php?mod=sign&act=list" target="_blank"><?php echo $tongji['sign_num'] ?> <span>次</span></a></td>
				</tr>
				</table>
				<div class="clear"></div>
			</div>
	...
	<div class="index_right">
		...
		<div class="xtxx mab15">
			...
			<tr>
<td align="right" class="c888" width="62">贼云支持</td>
				<td style="border-top:0"><a href="http://www.zeiyun.cn" target="_blank" class="corg">www.zeiyun.cn</a></td></tr>
			<tr>	<td align="right" class="c888" width="62">当前版本：</td>
				<td style="border-top:0"><a href="http://www.qiye1000.com" target="_blank" class="corg">XIAOYAO<?php echo $ini['xaoyao']['version'] ?></a></td>
			</tr>
			
			<tr>
				<td align="right" class="c888">QQ群：</td>
				<td>1062749519</td>
			</tr>
			<tr>
				<td align="right" class="c888">官方网站：</td>
				<td><a class="cblue" href="http://www.qiye1000.com" target="_blank">http://www.qiye1000.com</a></td>
			</tr>
			<tr>
