...
<div class="content" style="padding-top:0">
		...
		<div class="fl proinfo">
			...
			<div class="proinfo_box">
				...
				<tr>
					...
					<td>
						<span class="jg_price">
							<span class="fl"><span class="font18">¥</span> <span id="product_money"><?php echo $info['product_money'] ?></span></span>
							<span class="fl ptname"><?php echo $info['product_ptnum'] ?>人拼团价</span>
						</span>
					</td>
				</tr>
				</table>
			...
			<tr>
				...
				<td>
					...
					<div class="pro_foot_right">
						<a href="javascript:buy_btn('buy', '<?php echo $info['product_id'] ?>');">¥<?php echo $info['product_smoney'] ?> 单买</a>
						<?php if($_g_pintuan_id):?>
						<a href="javascript:buy_btn('pintuan', '<?php echo $info['product_id'] ?>');" class="gm">¥<?php echo $info['product_money'] ?> 参团</a>
						<?php else:?>
						<a href="javascript:buy_btn('pintuan', '<?php echo $info['product_id'] ?>');" class="gm">¥<?php echo $info['product_money'] ?> 开团</a>
						<?php endif;?>
						<div class="clear"></div>
					</div>
					<?php endif;?>
			...
			<div class="pt_box">
				...
				<div class="pt_info">
					...
					<li><div><span class="pt_num">2</span>邀请好友<p>参团并支付</p></div></li>
					<li><div><span class="pt_num">3</span>24小时内<p>达到人数成团</p></div></li>
					</ul>
					<div class="clear"></div>
				</div>
			</div>
	...
	<div class="fr xiangqing">
		...
		<div class="promain js_menuhtml">
			...
			<div id="product_video" style="width:600px;height:450px;"></div>
			<?php endif;?>
...
function buy_btn(act, id) {
	...
	pe_getinfo("<?php echo $pe['host_root'] ?>index.php?mod=cart&act="+act+"&id="+id+"&guid="+$(":input[name='product_guid']").val()+"&num="+$(":input[name='product_num']").val()+"&pintuan_id=<?php echo $_g_pintuan_id ?>", function(json){
		if (json.result == true) {
			...
			/*if (act == 'buy') {
				...
				pe_open("<?php echo $pe['host_root'] ?>index.php?mod=order&act=add_pintuan&ptid=<?php echo $order_ptid ?>&id="+json.id);
			}
			else {
