...
<div class="right">
	<div class="now">
		<a href="webadmin.php?mod=cache" class="sel"><?php echo $menutitle ?><i></i></a>
		<div class="clear"></div>
	</div>
	...
	<div class="right_main">
		...
		<tr>
			...
			<td><a href="webadmin.php?mod=cache&act=update&cache=<?php echo $k ?>&token=<?php echo $pe_token ?>" class="admin_edit">更新</a></td>
		</tr>
		<?php endforeach;?>
		</table>
	</div>
	<div class="center mat20">
		...
		<input type="button" name="pesubmit" value="全部更新" class="tjbtn" href="webadmin.php?mod=cache&act=update&cache=all&token=<?php echo $pe_token ?>" onclick="return pe_doall(this, 'form')" />
	</div>
	</form>
</div>
