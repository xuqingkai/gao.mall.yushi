...
<div class="quick_menu">
	<div class="width980">
		...
		<div class="fr top_r">
			...
			<a href="<?php echo pe_url('article-news') ?>" title="资讯中心" style="border-right:0;">资讯中心</a>
		</div>
		<div class="clear"></div>
	</div>
</div>
...
<div class="width980">
	<div class="header">
		...
		<div class="head_gwc"><a href="<?php echo pe_url('cart') ?>"><div class="head_gwc_tb">购物车 <span class="num cred js_cartnum"><?php echo user_cartnum() ?></span> 件　 ></div></a></div>
...
<div class="nav">
	...
	<li class="sel" style="width:228px; position:relative;z-index:999" id="menu_nav">
		<h3 class="all"><a href="<?php echo $pe['host_root'] ?>index.php?mod=product&act=list"><span></span>全部商品</a></h3>
		<div id="menu_html" <?php if($mod!='index'):?>style="display:none"<?php endif;?>>
			<div class="fl_index">
				<?php foreach((array)$cache_category_arr[0] as $k=>$v):?>
				<?php $i++;?>
				<div class="fenlei_li <?php if($i>12):?>fenlei_li_more<?php endif;?>">
					<div class="fenlei_h3">
