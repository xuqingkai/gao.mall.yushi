...
$alipay_config['notify_url'] = "{$pe['host_root']}public/plugin/payment/alipay/notify_url.php";

// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
$alipay_config['return_url'] = "{$pe['host_root']}public/plugin/payment/alipay/return_url.php";
...
$alipay_config['cacert']    = "{$pe['path_root']}public/plugin/payment/alipay/cacert.pem";
